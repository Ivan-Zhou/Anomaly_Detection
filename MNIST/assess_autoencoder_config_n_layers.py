...
n_layers_list = [6,7,8,9] # Set Configuration to Test
multiplier = 2 # Multiplier of change in layer size: must larger than 1
...
plt.savefig('results/autoencoder_config_assessment_n_layers2.png')
print('Plot is saved.')
